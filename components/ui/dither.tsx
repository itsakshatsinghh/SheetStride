...
function DitheredWaves({
  ...
  useFrame(({ clock }) => {
    ...
    // Dynamic breathing calculations for organic idle morphing
    const breatheAmp = waveAmplitude + Math.sin(time * 0.8) * 0.06;
    const breatheFreq = waveFrequency + Math.cos(time * 0.6) * 0.4;

    if (u.waveSpeed.value !== waveSpeed) u.waveSpeed.value = waveSpeed;
    u.waveFrequency.value = breatheFreq;
    u.waveAmplitude.value = breatheAmp;
